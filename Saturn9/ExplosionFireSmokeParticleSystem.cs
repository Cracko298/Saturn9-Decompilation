...
public class ExplosionFireSmokeParticleSystem : DefaultSprite3DBillboardTextureCoordinatesParticleSystem
{
	...
	public void LoadEvents()
	{
		...
		base.Emitter.ParticlesPerSecond = 20f;
	...
	{
		particle.Lifetime = base.RandomNumber.Between(0.5f, 0.75f);
		particle.Color = (particle.StartColor = Color.Gray);
		particle.EndColor = Color.Black;
		particle.Position = base.Emitter.PositionData.Position;
		particle.Velocity = DPSFHelper.RandomNormalizedVector() * base.RandomNumber.Next(1, 50) * 0.02f;
		particle.ExternalForce = new Vector3(0f, 0.5f, 0f);
