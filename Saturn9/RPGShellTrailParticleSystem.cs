...
public class RPGShellTrailParticleSystem : DefaultSprite3DBillboardTextureCoordinatesParticleSystem
{
	...
	public RPGShellTrailParticleSystem(Game game)
		: base(game)
	{
	}
	...
	public void LoadEvents()
	{
		...
		base.Emitter.ParticlesPerSecond = 30f;
